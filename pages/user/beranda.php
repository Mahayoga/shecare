<div class="site-wrap">
        ...
        <div class="col-md-10">
          ...
          <div class="row justify-content-center mb-4">
            <div class="col-md-10 text-center">
              ...
              <p data-aos="fade-up" data-aos-delay="100"><a href="#" class="btn btn-primary btn-pill">Mulai Analisa</a>
              </p>
            </div>
          </div>
      ...
      <div class="row">
        ...
        <div class="mb-4 mb-lg-0 col-sm-6 col-md-6 col-lg-3">
          <div class="block-service-1-card">
            <a href="#" class="thumbnail-link d-block mb-4"><img src="assets/user/images/img_1.jpg" alt="Image"
                class="img-fluid"></a>
        ...
        <div class="mb-4 mb-lg-0 col-sm-6 col-md-6 col-lg-3">
          <div class="block-service-1-card">
            <a href="#" class="thumbnail-link d-block mb-4"><img src="assets/user/images/img_2.jpg" alt="Image"
                class="img-fluid"></a>
        ...
        <div class="mb-4 mb-lg-0 col-sm-6 col-md-6 col-lg-3">
          <div class="block-service-1-card">
            <a href="#" class="thumbnail-link d-block mb-4"><img src="assets/user/images/img_3.jpg" alt="Image"
                class="img-fluid"></a>
    ...
    <div class="container">
      <div class="d-block d-lg-flex">
        <div class="half-wrap d-block d-md-flex">
          ...
          <div class="half bg-img img" style="background-image: url('assets/user/images/img_1.jpg');"></div>
        </div>
        <div class="half-wrap d-block d-md-flex">
          <div class="half bg-white d-block d-md-flex arrow-right">
            <div class="text">
          ...
          <div class="half bg-img img" style="background-image: url('assets/user/images/img_2.jpg');"></div>
        </div>
      </div>
      ...
      <div class="d-block d-lg-flex">
        <div class="half-wrap d-block d-md-flex">
          ...
          <div class="half bg-img img" style="background-image: url('assets/user/images/img_3.jpg');"></div>
        </div>
        <div class="half-wrap d-block d-md-flex">
          <div class="half bg-white  d-block d-md-flex arrow-left order-md-2">
            <div class="text">
          ...
          <div class="half bg-img img" style="background-image: url('assets/user/images/img_4.jpg');"></div>
        </div>
      </div>
    </div>
  </div>
          ...
          <div class="owl-carousel-2 owl-carousel">
            ...
            <div class="d-block block-testimony mx-auto text-center">
              <div class="person w-25 mx-auto mb-4">
                <img src="assets/user/images/person_1.jpg" alt="Image" class="img-fluid rounded-circle w-50 mx-auto">
              </div>
              <div>
            ...
            <div class="d-block block-testimony mx-auto text-center">
              <div class="person w-25 mx-auto mb-4">
                <img src="assets/user/images/person_2.jpg" alt="Image" class="img-fluid rounded-circle w-50 mx-auto">
              </div>
              <div>
            ...
            <div class="d-block block-testimony mx-auto text-center">
              <div class="person w-25 mx-auto mb-4">
                <img src="assets/user/images/person_3.jpg" alt="Image" class="img-fluid rounded-circle w-50 mx-auto">
              </div>
              <div>
                <h2 class="h5 mb-4">Katie Johnson</h2>
                <blockquote>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias accusantium qui
            ...
            <div class="d-block block-testimony mx-auto text-center">
              <div class="person w-25 mx-auto mb-4">
                <img src="assets/user/images/person_4.jpg" alt="Image" class="img-fluid rounded-circle w-50 mx-auto">
              </div>
              <div>
                <h2 class="h5 mb-4">Jun Mars</h2>
                <blockquote>&ldquo;Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias accusantium qui
  ...
  <div class="mt-5 block-cta-1 primary-overlay" style="background-image: url('assets/user/images/hero_bg_2.jpg')">
    <div class="container">
      <div class="row align-items-center justify-content-between">
        <div class="col-lg-7 mb-4 mb-lg-0">
          <h2 class="mb-3 mt-0 text-white">Upto 30% Discount for The First Commers</h2>
          <p class="mb-0 text-white lead">Far far away, behind the word mountains, far from the countries Vokalia and
